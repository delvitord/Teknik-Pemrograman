...
class EngineerTools {
    ...
    void removeDataOpsTools() {
        try {
        	boolean x;
        	x = this.EngTools.removeAll(this.DataOpsTools);
        	assert x : "Failed to remove!";
